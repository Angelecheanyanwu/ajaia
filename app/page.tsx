                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
                            The lightweight, collaborative document editor
                            designed for fast-moving teams. Rich-text
                            formatting, easy sharing, and seamless file imports.
                        </p>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <p className="text-xs text-gray-400 mt-4 leading-relaxed">
                                        * For this evaluation, using any email
                                        will auto-create a persistent account.
                                        Default password is{" "}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-500 leading-relaxed">
                                A seamless editing experience with bold, italic,
                                headings, and lists. Focus on your content
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-500 leading-relaxed">
                                Collaborate instantly. Grant access to teammates
                                via email and distinguish between owned and
                                shared documents.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-500 leading-relaxed">
                                Your work is always saved and preserved. Built
                                with industry-standard persistence to ensure
